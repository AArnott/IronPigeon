...
namespace IronPigeon
{
    ...
    public interface ICloudBlobStorageProvider
    {
        ...
        Task<Uri> UploadMessageAsync(Stream content, DateTime expirationUtc, string? contentType = null, string? contentEncoding = null, IProgress<long>? bytesCopiedProgress = null, CancellationToken cancellationToken = default(CancellationToken));
    }
}
