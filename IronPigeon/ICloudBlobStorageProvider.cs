namespace IronPigeon {
	...
	public interface ICloudBlobStorageProvider {
		...
		/// </summary>
		/// <param name="encryptedMessageContent">The blob's content.</param>
		...
		Task<Uri> UploadMessageAsync(Stream encryptedMessageContent, DateTime expirationUtc, CancellationToken cancellationToken = default(CancellationToken));
	}
}
